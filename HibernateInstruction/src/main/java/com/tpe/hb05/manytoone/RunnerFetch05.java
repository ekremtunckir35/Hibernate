...
public class RunnerFetch05 {
    public static void main(String[] args) {
        ...
        for (Student05 s:resultList){
           ...
           //university.getStudents() --- tek yonlu iliski  ancak sorgu yazxarak yapabiliyoruz

        //öğrencilerin isimlerini, notlarını ve  üniversitelerinin isimlerini yazdıralım
