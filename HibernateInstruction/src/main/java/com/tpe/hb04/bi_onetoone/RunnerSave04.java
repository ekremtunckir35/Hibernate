...
public class RunnerSave04 {
    public static void main(String[] args) {
        ...
        //student tablosunda diary
        //diary de student  birakildi


        //Iki obje iliskilendirilir iken iliski sahibi olan tablo(class) tarafinda set etmeliyiz
        diary1.setStudent(student1);  //FK sutununa ogrencinin ID si eklensin
        diary2.setStudent(student3);


        //student1.setDiary(diary1);--->//mappedBy ile otomatik olrak yapiliyor
