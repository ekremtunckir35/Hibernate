...
public class RunnerSave03 {
    public static void main(String[] args) {
        ...
        student1.setId(1001);
        student1.setName("Ahmet Kaya");
        student1.setGrade(90);

        Student03 student2 = new Student03();
        student2.setId(1002);
        student2.setName("Edip Akbayram");
        student2.setGrade(90);

        Student03 student3 = new Student03();
        student3.setId(1003);
        student3.setName("Sezen Aksu");
        student3.setGrade(90);

        Diary diary1 = new Diary();
        diary1.setId(101);
        diary1.setName("Edip Akbayram'in Gunlugu");
        diary1.setStudent(student1);

        Diary diary2 = new Diary();
        diary2.setId(102);
        diary2.setName("Sezen Aksunun Gunlugu");
